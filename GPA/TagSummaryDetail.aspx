<%@ Page Language="C#" MasterPageFile="~/TagFilter.master" AutoEventWireup="true" CodeBehind="TagSummaryDetail.aspx.cs" Inherits="GPA.TagSummaryDetail" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/TagFilter.master" %>
		...
		<asp:Panel ID="Summary" runat="server" CssClass="SectionPanel">
            ...
            <asp:TableRow>
              <asp:TableCell Height="25">
								...
								<asp:UpdatePanel ID="DetailPanel" runat="server" RenderMode="Inline">
                                <ContentTemplate>
                                <asp:ImageButton runat="server" ID="ibDetails" ImageUrl="~/Images/filter_details.gif" CssClass="toolbarimage" OnClick="ibDetails_Click" ToolTip="View Details for selected item" />
                                <asp:ImageButton runat="server" ID="ibBulkEdit" ImageUrl="~/Images/bulkedit.gif" CssClass="toolbarimage" OnClick="ibBulkEdit_Click" ToolTip="Bulk Edit page" />
                                </ContentTemplate>
                                </asp:UpdatePanel>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<asp:CheckBox ID="cbActive" runat="server" CssClass="toolbarlabel" Text="" AutoPostBack="true" Font-Bold="true" OnCheckedChanged="cbActiveChanged" Visible="false" />
								<asp:Label ID="lbActive" runat="server" CssClass="toolbarlabel" Text="Show Obsolete" Visible="false" />
								<asp:Label ID="lbToday" runat="server" CssClass="toolbarlabel" Visible="false" Text="Show Today" />
								<asp:Button ID="btnViewReport" runat="server" CssClass="toolbarlabel" Text="ViewReport" OnClick="OnViewReport" Visible="false" />
								</ContentTemplate></asp:UpdatePanel>
              </asp:TableCell>
							<asp:TableCell Width="50">
					      <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanel_Summary" DisplayAfter="1" >
									<ProgressTemplate>
										<asp:Image CssClass="UpdateImage" ID="LoadImage" runat="server" ImageUrl="~/Images/ajax-loader.gif" />
									</ProgressTemplate>
								</asp:UpdateProgress>
					      <asp:UpdateProgress ID="UpdateProgress2" runat="server" AssociatedUpdatePanelID="UpdatePanel_Detail" DisplayAfter="1" >
									<ProgressTemplate>
						...
						<asp:UpdatePanel ID="UpdatePanel_Detail" runat="server">
							<ContentTemplate>
								<lms2:PCSDetailsView ID="DetailsView1" runat="server" CellPadding="4" BorderStyle="Solid" BorderWidth="1px" CssClass="TagGridFilter"
									ForeColor="#333333" GridLines="Horizontal" DataSourceID="SASDetailDataSource1" AutoGenerateRows="false"
									 OnItemInserted="MarkCacheStale" OnItemDeleted="MarkCacheStale" OnItemUpdated="MarkCacheStale" OnDataBound="DetailDataBound">
									<FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
									<CommandRowStyle CssClass="noPrint" BackColor="#D1DDF1" Font-Bold="True" />
									<RowStyle BackColor="#EFF3FB" />
									<FieldHeaderStyle BackColor="#DEE8F5" Font-Bold="True" />
									<PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
									<Fields>
										<asp:CommandField ButtonType="Image" CancelImageUrl="~/images/cancel_sm.gif" 
											...
											UpdateImageUrl="~/images/update_sm.gif" NewImageUrl="~/images/noImage.gif"
