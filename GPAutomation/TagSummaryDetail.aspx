<%@ Page Title="OffScanTree" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TagSummaryDetail.aspx.cs" Inherits="GPAutomation.TagSummaryDetail" %>
				...
				<td nowrap="nowrap" align="right" width="20%" valign="middle">
					<asp:UpdatePanel ID="userPanel" runat="server">
						<ContentTemplate>
							...
							<asp:ImageButton runat="server" ID="ImageButton2" ImageUrl="~/Images/User.gif" ToolTip="Change user" ImageAlign="Middle"/>	
						</ContentTemplate>
					</asp:UpdatePanel>
				</td>
			</tr>
          ...
          <asp:TableRow>
            <asp:TableCell Height="25">
						...
						<asp:UpdatePanel ID="DetailPanel" runat="server" RenderMode="Inline">
                              <ContentTemplate>
                              <asp:ImageButton runat="server" ID="ibDetails" ImageUrl="~/Images/filter_details.gif" CssClass="toolbarimage" ToolTip="View Details for selected item" />
                              <asp:ImageButton runat="server" ID="ibBulkEdit" ImageUrl="~/Images/bulkedit.gif" CssClass="toolbarimage" ToolTip="Bulk Edit page" />
                              </ContentTemplate>
                              </asp:UpdatePanel>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:CheckBox ID="cbActive" runat="server" CssClass="toolbarlabel" Text="" AutoPostBack="true" Font-Bold="true"  Visible="false" />
						...
						<asp:Button ID="btnViewReport" runat="server" CssClass="toolbarlabel" Text="ViewReport"  Visible="false" />
